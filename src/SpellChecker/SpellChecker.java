...
public class SpellChecker {
     ...
     *
     * @return the selected input file, or null if no file is selected
     */
     ...
     * The variations are generated by deleting a letter, changing a letter, inserting a letter,
     * swapping neighboring characters, or inserting a space in the badWord.
     *
     * @param badWord    the misspelled word
     * @param dictionary the dictionary set to check against
     * @return a sorted set of suggestions for the misspelled word
     */
